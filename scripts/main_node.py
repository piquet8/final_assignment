...
def change_state():
    global state_, state_desc_, y_val,x_targ,y_targ, x_val, srv_client_wall_follower_, srv_client_random_position,srv_client_user_interface, pub_cmdvel, pub_mvbase
    ...
    if state_ == 1:
        	...
        	resp1 = srv_client_random_position()
        	#acquire new values from the service
        	x_targ=resp1.x
        	y_targ=resp1.y
        	#set the new target position
		rospy.set_param('des_pos_x', x_targ)
    		rospy.set_param('des_pos_y', y_targ)
...
def main():
    ...
    srv_client_random_position = rospy.ServiceProxy('/random_position', Random_position)
